...
\usepackage{array,tabularx}% readable wrapping tables
...
\newcommand{\ResultCI}[2]{%
  ...
  \begin{tabular}[c]{@{}c@{}}#1\\[-0.35ex]{\footnotesize\mbox{#2}}\end{tabular}%
  \endgroup
}
\newcommand{\BestResultCI}[2]{%
  \begingroup
  \renewcommand{\arraystretch}{0.78}%
  \begin{tabular}[c]{@{}c@{}}\textbf{#1}\\[-0.35ex]{\footnotesize\bfseries\mbox{#2}}\end{tabular}%
  \endgroup
}
...
\input{Tex/Appendix}% reproducibility appendix
%-
%-> Backmatter
%-
\backmatter% initialize the environment
\input{Tex/Backmatter}% acknowledgements
\end{document}
%---------------------------------------------------------------------------%
